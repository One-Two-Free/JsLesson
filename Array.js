...
1-й элемент будет стоять вторым, будет перестоновка
	если вернется положительное число,
первым, перестановки нет
	если отрицательное
...
Метод вызывает функцию callback по одному разу для каждого элемента массива в порядке возрастания индекса.
